	...
	* oat=<50(10C)
	...
	if oat>75.0:  # 24C
		...
		if (time_of_day.hour<=9) & (time_of_day.hour > 4):
			prop_stp = 65.0 + np.random.normal(0.8,0.35)
		...
		if (time_of_day.hour<=24) & (time_of_day.hour > 21):
			prop_stp = 65.5 + np.random.normal(0.8,0.35)
	if (oat<=75.0) & (oat > 66.0):  # (20C,24C)
		if (time_of_day.hour<=4) & (time_of_day.hour > 0):
			prop_stp = 65.5+np.random.normal(1.0,0.35)
		if (time_of_day.hour<=9) & (time_of_day.hour > 4):
			prop_stp = 66.5+np.random.normal(0.8,0.35)
		if (time_of_day.hour<=18) & (time_of_day.hour > 9):
			prop_stp = 65.0+np.random.normal(0.8,0.35)
		if (time_of_day.hour<=21) & (time_of_day.hour > 18): 
	...
	if (oat<=50.0) :  # (10C)
		...
		if (time_of_day.hour<=9) & (time_of_day.hour > 4):
			prop_stp = 70.5+np.random.normal(0.8,0.35)
		if (time_of_day.hour<=18) & (time_of_day.hour > 9):
			prop_stp = 69.0+np.random.normal(2.0,0.35)
		if (time_of_day.hour<=21) & (time_of_day.hour > 18): 
			prop_stp = 68.5+np.random.normal(1.8,0.35)
		if (time_of_day.hour<=24) & (time_of_day.hour > 21):
			prop_stp = 68.5+np.random.normal(1.0,0.35)
